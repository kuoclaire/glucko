...
window.GluckoState = {
    ...
    employees: [
        ...
        { id: 'DOC-101', role: 'doctor', hospital: 'General Memorial Hospital', password: 'password', name: 'Dr. John Smith', phone: '555-0100', email: 'smith@gmh.com' },
        { id: 'DOC-102', role: 'doctor', hospital: 'Westside Clinic', password: 'password', name: 'Dr. Sarah Connor', phone: '555-0200', email: 'sconnor@wc.com' }
    ],
